...
func factory_DeviceActor() gen.ProcessBehavior {
	return &DeviceActor{}
}
...
func (a *DeviceActor) Init(args ...any) error {
...
func (a *DeviceActor) HandleMessage(from gen.PID, message any) error {
...
func (a *DeviceActor) HandleCall(from gen.PID, ref gen.Ref, request any) (any, error) {
	a.Log().Info("got request from %s with reference %s", from, ref)
	return gen.Atom("pong"), nil
}

// Terminate invoked on a termination process
func (a *DeviceActor) Terminate(reason error) {
...
func (a *DeviceActor) HandleMessageName(name gen.Atom, from gen.PID, message any) error {
	return nil
}

// HandleMessageAlias invoked if split handling was enabled using SetSplitHandle(true)
// and message has been sent by alias
func (a *DeviceActor) HandleMessageAlias(alias gen.Alias, from gen.PID, message any) error {
	return nil
}

// HandleCallName invoked if split handling was enabled using SetSplitHandle(true)
// and request was made by name
func (a *DeviceActor) HandleCallName(name gen.Atom, from gen.PID, ref gen.Ref, request any) (any, error) {
	return gen.Atom("pong"), nil
}

// HandleCallAlias invoked if split handling was enabled using SetSplitHandle(true)
// and request was made by alias
func (a *DeviceActor) HandleCallAlias(alias gen.Alias, from gen.PID, ref gen.Ref, request any) (any, error) {
	return gen.Atom("pong"), nil
}
...
func (a *DeviceActor) HandleLog(message gen.MessageLog) error {
	return nil
}
...
func (a *DeviceActor) HandleEvent(message gen.MessageEvent) error {
	return nil
}

// HandleInspect invoked on the request made with gen.Process.Inspect(...)
func (a *DeviceActor) HandleInspect(from gen.PID, item ...string) map[string]string {
