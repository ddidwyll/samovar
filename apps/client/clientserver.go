...
func factory_ClientServer() gen.ProcessBehavior {
	return &ClientServer{}
}
...
func (w *ClientServer) Init(args ...any) (act.PoolOptions, error) {
	...
	poolOptions.WorkerFactory = factory_ClientServerWebWorker
