...
func factory_ScriptSup() gen.ProcessBehavior {
	return &ScriptSup{}
}

type ScriptSup struct {
	act.Supervisor
}

// Init invoked on a spawn Supervisor process. This is a mandatory callback for the implementation
func (sup *ScriptSup) Init(args ...any) (act.SupervisorSpec, error) {
...
func (sup *ScriptSup) HandleChildStart(name gen.Atom, pid gen.PID) error {
	return nil
}

// HandleChildTerminate invoked on a child process termination if option EnableHandleChild
// was enabled in act.SupervisorSpec
func (sup *ScriptSup) HandleChildTerminate(name gen.Atom, pid gen.PID, reason error) error {
	return nil
}
...
func (sup *ScriptSup) HandleMessage(from gen.PID, message any) error {
...
func (sup *ScriptSup) HandleCall(from gen.PID, ref gen.Ref, request any) (any, error) {
...
func (sup *ScriptSup) Terminate(reason error) {
	sup.Log().Info("supervisor terminated with reason: %s", reason)
}

// HandleInspect invoked on the request made with gen.Process.Inspect(...)
func (sup *ScriptSup) HandleInspect(from gen.PID, item ...string) map[string]string {
