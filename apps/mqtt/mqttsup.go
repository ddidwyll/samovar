...
func factory_MqttSup() gen.ProcessBehavior {
	return &MqttSup{}
}
...
func (sup *MqttSup) Init(args ...any) (act.SupervisorSpec, error) {
...
func (sup *MqttSup) HandleChildStart(name gen.Atom, pid gen.PID) error {
	return nil
}

// HandleChildTerminate invoked on a child process termination if option EnableHandleChild
// was enabled in act.SupervisorSpec
func (sup *MqttSup) HandleChildTerminate(name gen.Atom, pid gen.PID, reason error) error {
	return nil
}
...
func (sup *MqttSup) HandleMessage(from gen.PID, message any) error {
...
func (sup *MqttSup) HandleCall(from gen.PID, ref gen.Ref, request any) (any, error) {
...
func (sup *MqttSup) Terminate(reason error) {
	sup.Log().Info("supervisor terminated with reason: %s", reason)
}

// HandleInspect invoked on the request made with gen.Process.Inspect(...)
func (sup *MqttSup) HandleInspect(from gen.PID, item ...string) map[string]string {
