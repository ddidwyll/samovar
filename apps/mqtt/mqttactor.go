...
func factory_MqttActor() gen.ProcessBehavior {
	return &MqttActor{}
}
...
func (a *MqttActor) Init(args ...any) error {
...
func (a *MqttActor) HandleMessage(from gen.PID, message any) error {
...
func (a *MqttActor) HandleCall(from gen.PID, ref gen.Ref, request any) (any, error) {
	a.Log().Info("got request from %s with reference %s", from, ref)
	return gen.Atom("pong"), nil
}

// Terminate invoked on a termination process
func (a *MqttActor) Terminate(reason error) {
...
func (a *MqttActor) HandleMessageName(name gen.Atom, from gen.PID, message any) error {
	return nil
}

// HandleMessageAlias invoked if split handling was enabled using SetSplitHandle(true)
// and message has been sent by alias
func (a *MqttActor) HandleMessageAlias(alias gen.Alias, from gen.PID, message any) error {
	return nil
}

// HandleCallName invoked if split handling was enabled using SetSplitHandle(true)
// and request was made by name
func (a *MqttActor) HandleCallName(name gen.Atom, from gen.PID, ref gen.Ref, request any) (any, error) {
	return gen.Atom("pong"), nil
}

// HandleCallAlias invoked if split handling was enabled using SetSplitHandle(true)
// and request was made by alias
func (a *MqttActor) HandleCallAlias(alias gen.Alias, from gen.PID, ref gen.Ref, request any) (any, error) {
	return gen.Atom("pong"), nil
}
...
func (a *MqttActor) HandleLog(message gen.MessageLog) error {
	return nil
}
...
func (a *MqttActor) HandleEvent(message gen.MessageEvent) error {
	return nil
}

// HandleInspect invoked on the request made with gen.Process.Inspect(...)
func (a *MqttActor) HandleInspect(from gen.PID, item ...string) map[string]string {
